...
INSERT INTO "new_requisicoes" ("colecao_id", "data", "id", "jsonEnvio", "nome", "pasta_id", "tipo", "url") SELECT "colecao_id", "data", "id", coalesce("jsonEnvio", '') AS "jsonEnvio", "nome", "pasta_id", "tipo", coalesce("url", '') AS "url" FROM "requisicoes";
