...
const EditorJson = forwardRef<HTMLTextAreaElement, EditorJsonProps>(
    ...
    return (
      <div className="flex flex-col gap-1 w-full h-full">
        <div className="flex justify-between">
          <h1 className="flex items-center justify-center h-9">
            Conteúdo JSON
          </h1>
          {!readOnly && (
            <Button
        ...
        <Textarea
          className="resize-none flex-grow md:text-lg"
          ref={textAreaRef}
